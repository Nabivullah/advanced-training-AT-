...
namespace CollegeRepositoryDataBase
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddCors(options =>
            {
                ...
                {
                    policy.WithOrigins("https://localhost:7035") // your UI project's URL
                          .AllowAnyHeader()
                          .AllowAnyMethod();
                });
            });
            ...
            builder.Services.AddDbContext<Models.NewCollegeDbContext>(options =>
            {
